...
{
  public class NavigationHelperBehavior : SafeBehavior<Page>, INotifyPropertyChanged
  {
    ...
    private Frame Frame
    {
      get
      {
        return this.Page != null ? this.Page.Frame : null;
      }
    }

    protected override void OnSetup()
    {
      SetupNavigationHelper(AssociatedObject);
      PropertyChanged(this, new PropertyChangedEventArgs("GoBackCommand"));
      PropertyChanged(this, new PropertyChangedEventArgs("GoForwardCommand"));
    }
    ...
    public void SetupNavigationHelper(Page page)
    {
      this.Page = page;
    ...
    {
      var frameState = SuspensionHelper.SessionStateForFrame(this.Frame);
